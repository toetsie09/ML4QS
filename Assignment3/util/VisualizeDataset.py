...
class VisualizeDataset:
    ...
    # Plot the datasets, here columns can specify a specific attribute, but also a generic name that occurs
    ...
    def plot_dataset(self, data_table, columns, match='like', display='line', name=""):
        ...
        for i in range(0, len(columns)):
            ...
            # which we need to find columns names in the datasets that contain the name.
            if match[i] == 'exact':
